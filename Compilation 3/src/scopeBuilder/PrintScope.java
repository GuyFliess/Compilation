...
public class PrintScope {
	...
	private void print(ClassScope classScope) {
		...
		if (classScope.HasSuperNode) {
			System.out.print(String.format("(parent = %s)",
					classScope.fatherScope.getName()));
		}
		System.out.println();
		...
		for (String name : fields.keySet()) {
			...
			System.out.println(String.format("    Field:  %s : %s", name,
					getFullName(type)));
		}
	...
	private void printMethod(Map<String, MethodTypeWrapper> methods,
			String typeOfMethods) {
	...
	private void print(MethodScope bodyScope) {
		...
		for (String name : parameters.keySet()) {
			System.out.println(String.format("    Parameter:  %s : %s", name,
					getFullName(parameters.get(name))));
		}
		...
		for (String name : localVariables.keySet()) {
			System.out.println(String.format("    Local variable:  %s : %s",
					name, getFullName(localVariables.get(name))));
		}
		System.out.println();
