...
public class AddressCodeTranslator implements Visitor {
	...
	private void checkLengthNonNegativeInit(String arrayOffset,
			String runTimeErrorsChecksReg, String secondLabel) {
		instructions.add("\t#check i > 0 for array location");
		instructions
				.add("\t>= " + arrayOffset + " 0 " + runTimeErrorsChecksReg);
		instructions.add("\tif " + runTimeErrorsChecksReg + " " + secondLabel);
	...
	private void arrayAddressPositive(String arrayAddress,
		...
		instructions.add("\t#check a > 0 for array address");
		instructions
	...
	public Object visit(StaticCall call) {
		...
		instructions.add("#Static call " + call.getClassName() + "."
				+ call.getMethod());
	...
	public Object visit(VirtualCall call) {
		instructions.add("#Virtual call " + call.getMethod());
	...
	private String invokeVirtualMethod(VirtualCall call, ClassScope classScope) {
		...
		instructions.add("#Virtual call: preparing activation record");
		...
		instructions.add("# 'this' goes in first place");
	...
	public Object visit(NewInstance newClass) {
		...
		instructions.add("#setting dispatch vector");
	...
	public Object visit(Length length) {
		...
		// - if the array is not initialized (null) throw runtime error -
		// example 21a_null
